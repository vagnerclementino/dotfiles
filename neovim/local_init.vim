...
" Disable viewdoc default mappings
...
if status_ok then
  configs.setup {
    ensure_installed = { "lua", "vim", "vimdoc", "markdown", "bash", "python", "go" },
    highlight = {
      enable = true,
    },
  }
...
" Goyo (distraction-free writing) - <leader>z for zen mode
nnoremap <leader>z :Goyo<CR>

" Limelight (focus on current paragraph)
nnoremap <leader>l :Limelight!!<CR>

" Goyo integration with Limelight (auto-enable when entering Goyo)
autocmd! User GoyoEnter Limelight
autocmd! User GoyoLeave Limelight!

" Goyo default width (comfortable for reading/writing)
...
augroup markdown_config
  ...
  " Navigate by visual lines in markdown
  autocmd FileType markdown nnoremap <buffer> j gj
  autocmd FileType markdown nnoremap <buffer> k gk
augroup END

" Quick spell fix (accept first suggestion)
...
" Fold by markdown headers
nnoremap <leader>mf :set foldmethod=expr foldexpr=getline(v:lnum)=~'^##'?'>1':'='<CR>
